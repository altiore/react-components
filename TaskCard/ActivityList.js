...
var ActivityListJsx = /** @class */ (function (_super) {
    __extends(ActivityListJsx, _super);
    function ActivityListJsx(props) {
    ...
    ActivityListJsx.prototype.handleToggleVisibleClick = function (e) {
        e.preventDefault();
        this.setState({
    ...
    ActivityListJsx.prototype.render = function () {
        ...
        return (React.createElement("div", { styleName: "activity-list-container" },
            ...
            isVisible && (React.createElement("div", { styleName: "list" }, list.map(function (item) { return (React.createElement(ActivityItem_1.ActivityItem, __assign({}, item))); })))));
    };
    ActivityListJsx.defaultProps = {
        visible: true
    };
    return ActivityListJsx;
}(React.Component));
var ActivityList = CSSModules(ActivityListJsx, s);
